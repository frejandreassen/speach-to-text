...
language_options = {
    ...
    "Spanish (Spain)": ("spanish-spain", "es-ES"), 
    "Swedish": ("swedish", "sv-SE"), 
    "Tamil": ("tamil", "ta-IN"), 
    "Telugu": ("telugu", "te-IN"), 
    "Thai": ("thai", "th-TH"), 
